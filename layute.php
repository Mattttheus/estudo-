...
<body>
            ...
            <section class="py-5 text-center container">
                <div class="row py-lg-5">
                    <div class="col-lg-6 col-md-8 mx-auto">
                        <h1 class="fw-light">Escola de Musica Virtual</h1>
                        <p class="lead text-body-secondary">"Aqui você estuda para provas e concursos, com materiais
                            constantemente atualizados, produzido por profissionais experientes. Aulas interativas, onde
                            demostramos a interação entre o conteúdo teórico e a prática relacionada a cada uma das
                            disciplinas.</p>
                        <p>
                            <a href="matricula.php" class="btn btn-primary my-2">Matricule-se</a>
                            <a href="area_aluno.php" class="btn btn-secondary my-2">Area Do Aluno</a>
                        </p>
                    </div>
                </div>
            </section>
    ...
    <script src="ks/bootstrap.min.js">
    </script>
</body>
